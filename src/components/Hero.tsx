        ...
        <div className="relative container mx-auto px-1 py-12 h-full">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-10">
            ...
            <div className="w-full lg:w-1/2 text-white">
              ...
              <p className="text-lg text-stone-600 mb-8 leading-relaxed max-w-lg font-poppins font-normal">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <a
                  ...
                  className="inline-block bg-laranja text-white px-6 md:px-8 py-3 rounded-md font-semibold hover:bg-orange-700 transition-colors text-sm md:text-base text-center"
                >
                  Agende uma Consulta
                </a>
                <a
                  href="#palestras-e-projetos"
                  className="inline-block bg-musgo text-white px-6 md:px-8 py-3 rounded-md font-semibold hover:bg-musgo-escuro transition-colors text-sm md:text-base text-center"
                >
